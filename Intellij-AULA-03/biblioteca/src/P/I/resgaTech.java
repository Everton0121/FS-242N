...
public class resgaTech {
    ...
    public class ConexaoDB {
        ...
        private static final String URL = "jdbc:mysql://localhost:3306/resgatch";
        ...
        public static void main(String[] args) {
            Connection testeConexao = Conexao.ConexaoDB.conectar();
            if (testeConexao != null) {
                // se a conexao for bem sucedida, podemos fecha-la
                Conexao.ConexaoDB.fecharConexao(testeConexao);
            }
        }
    }
}
