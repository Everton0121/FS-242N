...
public class MainApp extends JFrame {
    ...
    private void createMenuBar() {
        ...
        JMenu menuCurarPokemons = new JMenu("Curar Pokemons");
//        JMenu menuJson = new JMenu("JSON");
        ...
        JMenuItem itemCurarTodosPokemons = new JMenuItem("Curar Pokemons");
...
//        itemCurarTodosPokemons.addActionListener(e -> {
//            try {
//                opencurarTodosPokemons();
...
//    private void opencurarTodosPokemons() throws IOException{
//        pokemonController.curarTodosPokemons(pokemonController.listarTodosPokemons());
//        ListaPokemonsPanel listaPokemons = new ListaPokemonsPanel(pokemonController);
//        desktopPane.add(listaPokemons);
//        listaPokemons.setVisible(true);
//        listaPokemons.toFront();
