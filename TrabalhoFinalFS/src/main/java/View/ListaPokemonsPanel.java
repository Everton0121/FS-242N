...
public class ListaPokemonsPanel extends JInternalFrame {
    ...
    private JButton btnAtualizar, btnRemover, btnBuscar, btnEditar, btnBuscarTreinador, btnCurarTodosPokemons;
    ...
    public ListaPokemonsPanel(PokemonController controller) {
        ...
        btnCurarTodosPokemons = new JButton("Curar todos os Pokemons");
        ...
        panelAcoes.add(btnCurarTodosPokemons);
        ...
        btnCurarTodosPokemons.addActionListener(e -> curarTodosPokemons());
